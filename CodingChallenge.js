...
simply loop over the array. Formula: recommendedFood = weight ** 0.75 * 28. 
(The result is in grams of food, and the weight needs to be in kg)
2. Find Sarah's dog and log to the console whether it's eating too much 
or too little. HINT: Some dogs have multiple owners, so you first need to find Sarah 
...
console.log(dogs.unshift(dogs));
 /*const calculation = dogs.forEach(function(dog,i){
     const recommendedFood = (dog[i].weight) ** 0.75 * 28;
     console.log(dogs[i].push(recommendedFood));
  });*/
